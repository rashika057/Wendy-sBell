...
public class AdapterFishCart extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterFishCart(Context context, List<DataFishNew> data){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myHolder.fishName.setText("Item Name"+current.fishName);
        myHolder.fishPrice.setText("Total Price"+current.fishAmount+"Rs.");
        myHolder.fishQuantity.setText("Quantity"+current.fishQuantity);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView fishPrice,fishName,fishQuantity;
        ...
        public MyHolder(View itemView,Context context,List<DataFishNew> data) {
            ...
            fishQuantity=(TextView)itemView.findViewById(R.id.textFishQuantity);
        }
