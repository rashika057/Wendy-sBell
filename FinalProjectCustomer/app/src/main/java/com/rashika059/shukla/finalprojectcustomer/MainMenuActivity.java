...
public class MainMenuActivity extends AppCompatActivity
{
    ...
    private com.rashika059.shukla.finalprojectcustomer.AdapterFish mAdapter;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    fishData.fishDescription=json_data.getString("Description");
                ...
                mAdapter = new com.rashika059.shukla.finalprojectcustomer.AdapterFish(MainMenuActivity.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(MainMenuActivity.this));
